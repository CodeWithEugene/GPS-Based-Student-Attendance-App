    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.white }} edges={['top', 'bottom']}>
      <View style={{ flex: 1, padding: spacing.xl, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Body muted style={{ textAlign: 'center', marginTop: 6 }}>
          AttendEase needs GPS to confirm you are in class. Enable location in your phone settings to continue.
        </Body>
        <View style={{ height: 20 }} />
        <Button title="Open Phone Settings" onPress={() => {}} style={{ minWidth: 240 }} />
